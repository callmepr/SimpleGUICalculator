...
root.configure(background="#468DC0")
...
button_substract.grid(row=2,column=0)

button_0.grid(row=6,column=0)
button_clear.grid(row=6,column=1,columnspan=2,pady=1)
button_add.grid(row=1,column=0) 
button_equal.grid(row=2,column=1,pady=1,columnspan=2,ipadx=9) 

#---Entry text button----#
e=Entry(root,width=20,font=('Arial',21),fg='black',bg="#A4D54E")
